...
| **premium** | Todo lo anterior + contabilidad básica (plan de cuentas, libro de ingresos/gastos, balance de caja). Reservado también para lo que falta: facturación electrónica, CRM |
...
`api-keys` (plan Completo) o `accounting` (plan Premium) en `src/app.js` y
sus respectivos archivos de rutas.
