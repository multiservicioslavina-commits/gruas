...
var BACKGROUND = "rgb(31,36,40)", BACKGROUND__TRANSPARENT = "rgba(31,36,40, 0)", INPUT_BACKGROUND = "#2f363d", BORDER_COLOR = "#000", LIGHT_COLOR = "#ddd", SELECTED_BACKGROUND = "hsla(0, 0%, 100%, 0.15)", LIGHT_TEXT = "#A6A7A9", RULER_COLOR = "#808080", VERY_LIGHT_TEXT = "rgba(255, 255, 255, 0.3)", SELECTED_HOVER_BACKGROUND = "hsla(0, 0%, 100%, 0.25)", CLEAR_HOVER = "rgba(255, 255, 255, 0.06)", INPUT_BORDER_COLOR_UNHOVERED = "rgba(0, 0, 0, 0.6)", INPUT_BORDER_COLOR_HOVERED = "rgba(255, 255, 255, 0.05)", TIMELINE_BACKGROUND = "#111", FAIL_COLOR = "#ff3232", TEXT_COLOR = "#fff", WARNING_COLOR = "#f1c40f", BLUE = "#0b84f3", BLUE_DISABLED = "#284f73", LIGHT_TRANSPARENT = "rgba(255, 255, 255, 0.7)", UNSELECTED_GUIDE = "#7e1219", SELECTED_GUIDE = "#d22d3a", LINE_COLOR = "#363A3E", TIMELINE_TRACK_SEPARATOR = "rgba(0, 0, 0, 0.3)", getBackgroundFromHoverState = ({
  selected,
  hovered
}) => {
  if (selected) {
...
var canvasRef, drawRef;
var init_canvas_ref = __esm(() => {
  canvasRef = createRef();
  drawRef = createRef();
});

// src/components/Timeline/imperative-state.ts
var currentFrame = 0, currentZoom = 1, currentDuration = 1, currentFps = 1, getCurrentZoom = () => {
  return currentZoom;
}, setCurrentZoom = (z) => {
  currentZoom = z;
}, getCurrentFrame = () => {
...
var TIMELINE_PADDING = 16, TIMELINE_LAYER_HEIGHT = 25, TIMELINE_BORDER = 1, TIMELINE_ITEM_BORDER_BOTTOM = 1;
...
var init_get_left_of_timeline_slider = () => {};

// src/components/Timeline/TimelineSliderHandle.tsx
import { jsx } from "react/jsx-runtime";
var container, TimelineSliderHandle = () => {
...
var init_TimelineSliderHandle = __esm(() => {
  container = {
    width: 20,
    height: 20,
    position: "fixed",
...
var sliderAreaRef, scrollableRef, timelineVerticalScroll;
var init_timeline_refs = __esm(() => {
  sliderAreaRef = React.createRef();
  scrollableRef = React.createRef();
  timelineVerticalScroll = React.createRef();
});
...
var TimelineWidthContext, TimelineWidthProvider = ({ children }) => {
...
var init_TimelineWidthProvider = __esm(() => {
  init_timeline_refs();
  TimelineWidthContext = createContext(null);
});
...
var container2, line, redrawTimelineSliderFast, TimelineSlider = () => {
...
var init_TimelineSlider = __esm(() => {
  init_get_left_of_timeline_slider();
  init_TimelineSliderHandle();
  init_TimelineWidthProvider();
  init_timeline_refs();
  container2 = {
    position: "absolute",
    bottom: 0,
  ...
  redrawTimelineSliderFast = createRef2();
});
...
}, SCROLL_INCREMENT = 200, calculateFrameWhileScrollingRight = ({
  durationInFrames,
  width,
  scrollLeft
}) => {
...
}, getFrameIncrementFromWidth = (durationInFrames, width) => {
...
var init_timeline_scroll_logic = __esm(() => {
  init_TimelineSlider();
  init_timeline_refs();
});
...
var init_load_canvas_content_from_url = () => {};
...
var init_ZoomPersistor = __esm(() => {
  init_timeline_zoom();
  init_load_canvas_content_from_url();
});

// src/state/timeline-zoom.tsx
import { createContext as createContext2, useMemo as useMemo2, useState } from "react";
import { jsx as jsx4 } from "react/jsx-runtime";
var TIMELINE_MIN_ZOOM = 1, TIMELINE_MAX_ZOOM = 5, TimelineZoomCtx, TimelineZoomContext = ({ children }) => {
...
var init_timeline_zoom = __esm(() => {
  init_timeline_scroll_logic();
  init_ZoomPersistor();
  TimelineZoomCtx = createContext2({
    zoom: {},
    setZoom: () => {
...
var KeybindingContext, KeybindingContextProvider = ({ children }) => {
...
var init_keybindings = __esm(() => {
  KeybindingContext = createContext3({
    registerKeybinding: () => {
...
var HighestZIndexContext, HighestZIndexProvider = ({ children }) => {
...
var init_highest_z_index = __esm(() => {
  HighestZIndexContext = createContext4({
    highestIndex: 0,
    registerZIndex: () => {
      return;
    },
...
var clickLock = false, getClickLock = () => clickLock, setClickLock = (lock) => {
  clickLock = lock;
};
...
var ZIndexContext, margin, EscapeHook = ({ onEscape }) => {
  ...
  return null;
}, HigherZIndex = ({ children, onEscape, onOutsideClick, disabled }) => {
...
var init_z_index = __esm(() => {
  init_use_keybinding();
  init_highest_z_index();
  ZIndexContext = createContext5({
    currentIndex: 0
  });
  margin = {
    margin: "auto"
...
var init_is_current_selected_still = () => {};

// src/api/get-static-files.ts
var warnedServer = false, warnedPlayer = false, warnServerOnce = () => {
  if (warnedServer) {
    return;
  }
  warnedServer = true;
...
var breakpoint = 900, useMobileLayout = () => {
...
}, localStorageKey = (type) => type === "compositions" ? "remotion.expandedFolders" : "remotion.expandedAssetFolders", persistExpandedFolders = (type, state) => {
  window.localStorage.setItem(localStorageKey(type), JSON.stringify(state));
}, loadExpandedFolders = (type) => {
...
var init_persist_open_folders = __esm(() => {
  ExpandedFoldersContext = createContext6({
    toggleFolder: () => {},
    foldersExpanded: {},
    setFoldersExpanded: () => {}
  });
...
var FolderContext, FolderContextProvider = ({ children }) => {
...
var init_folders = __esm(() => {
  init_persist_open_folders();
  FolderContext = createContext7({
    compositionFoldersExpanded: {},
    setCompositionFoldersExpanded: () => {
...
var storageKey = (sidebar) => {
...
}, getSavedCollapsedStateLeft = (isMobileLayout = false) => {
  ...
  return "responsive";
}, getSavedCollapsedStateRight = (isMobileLayout = false) => {
  ...
  return "collapsed";
}, saveCollapsedState = (type, sidebar) => {
  window.localStorage.setItem(storageKey(sidebar), type);
}, SidebarContext, SidebarContextProvider = ({ children }) => {
...
var buildAssetFolderStructure = (files, parentFolderName, foldersExpanded) => {
...
}, splitParentIntoNameAndParent = (name) => {
  if (name === null) {
    return {
      name: null,
      parent: null
...
}, doesFolderExist = (items, folderName, parentName) => {
  ...
  return false;
}, findItemListToPush = (items, folderName, parentName) => {
  if (folderName === null) {
    return items;
  }
  ...
  return folder;
}, createFolderIfDoesNotExist = (items, availableFolders, folderItem, foldersExpanded) => {
...
}, createFolderTree = (comps, folders, foldersExpanded) => {
  const items = [];
...
var init_create_folder_tree = __esm(() => {
  init_persist_open_folders();
});
...
}, ExpandedFolderIcon = ({ color, ...props }) => {
  return /* @__PURE__ */ jsx10("svg", {
    viewBox: "0 0 576 512",
    ...props,
    children: /* @__PURE__ */ jsx10("path", {
...
}, ExpandedFolderIconSolid = ({ color, ...props }) => {
  return /* @__PURE__ */ jsx10("svg", {
    viewBox: "0 0 576 512",
    ...props,
    children: /* @__PURE__ */ jsx10("path", {
...
var notification, Notification = ({ children, id, duration, created, onRemove }) => {
  useEffect6(() => {
    if (duration === null) {
      return;
    }
...
var container3, notificationCenter, showNotification = (content, durationInMs) => {
...
var init_NotificationCenter = __esm(() => {
  init_Notification();
  container3 = {
    position: "absolute",
  ...
  notificationCenter = createRef3();
});

// src/components/PlayBeepSound.tsx
var beeped, playBeepSound = async (renderId) => {
  if (beeped[renderId]) {
    return;
  }
...
}, PlayBeepSound_default;
var init_PlayBeepSound = __esm(() => {
  beeped = {};
  PlayBeepSound_default = playBeepSound;
});
...
var RenderQueueContext, renderJobsRef, RenderQueueContextProvider = ({ children }) => {
...
var init_context = __esm(() => {
  RenderQueueContext = React11.createContext({
    jobs: []
  });
  renderJobsRef = createRef4();
});
...
var StudioServerConnectionCtx, PreviewServerConnection = ({ children, readOnlyStudio }) => {
...
var init_client_id = __esm(() => {
  init_NotificationCenter();
  init_PlayBeepSound();
  init_context();
  StudioServerConnectionCtx = React12.createContext({
    previewServerState: {
      type: "init"
    },
    subscribeToEvent: () => {
...
var init_InlineAction = __esm(() => {
  init_z_index();
});

// src/components/Menu/portals.ts
var portals, getPortal = (i) => {
  return portals[i];
};
...
var MENU_VERTICAL_PADDING = 4, SUBMENU_LEFT_INSET = -8, MAX_MENU_WIDTH = 400, MAX_MOBILE_MENU_WIDTH = 300, menuContainer, SHADOW_TOWARDS_BOTTOM = "0 2px 8px rgba(0, 0, 0, 0.5)", SHADOW_TOWARDS_TOP = "0 -2px 8px rgba(0, 0, 0, 0.5)", menuContainerTowardsBottom, menuContainerTowardsTop, fullScreenOverlay, outerPortal, inlineCodeSnippet;
...
var caret, caretDown, angleDown, CaretRight = () => /* @__PURE__ */ jsx20("svg", {
  viewBox: "0 0 192 512",
  style: caret,
...
var SPACING_UNIT = 8, Spacing = ({ x = 0, y = 0, block = false }) => {
...
}, flexCss, Flex = ({ children }) => /* @__PURE__ */ jsx21("div", {
  style: flexCss,
  children
}), Row = ({ children, justify, className, align, flex, style = {}, ...other }) => {
...
}, Column = ({ children, justify, className, align, style = {} }) => {
  const finalStyle = useMemo13(() => {
    return {
      ...style,
      display: "flex",
...
var MENU_INITIATOR_CLASSNAME = "__remotion-studio-menu-initiator", MENU_ITEM_CLASSNAME = "__remotion-studio-menu-item", HORIZONTAL_SCROLLBAR_CLASSNAME = "__remotion-horizontal-scrollbar", VERTICAL_SCROLLBAR_CLASSNAME = "__remotion-vertical-scrollbar", isMenuItem = (el) => {
...
var container4, labelStyle, keyHintCss, leftSpace, MenuSubItem = ({
  label,
  leaveLeftSpace,
  leftItem,
  onActionChosen,
...
var BORDER_SIZE = 1, container5, MenuContent = ({
  onHide,
  values,
  preselectIndex,
  onNextMenu,
...
var init_CompositionContextButton = __esm(() => {
  init_client_id();
  init_ellipsis();
  init_InlineDropdown();
});
...
var init_SidebarRenderButton = __esm(() => {
  init_client_id();
  init_mobile_layout();
  init_render();
  init_modals();
...
var COMPOSITION_ITEM_HEIGHT = 32, itemStyle, labelStyle2, iconStyle, CompositionSelectorItem = ({
  item,
  level,
  currentComposition,
  tabIndex,
...
var init_CompositionSelectorItem = __esm(() => {
  init_folder();
  init_still();
  init_video();
  init_modals();
  init_CompositionContextButton();
  init_ContextMenu();
  init_layout();
  init_NotificationCenter();
  init_SidebarRenderButton();
  itemStyle = {
    paddingRight: 10,
    paddingTop: 6,
    paddingBottom: 6,
...
var CURRENT_COMPOSITION_HEIGHT = 80, container6, title, subtitle, row, CurrentComposition = () => {
...
var init_CurrentComposition = __esm(() => {
  container6 = {
...
var container7, getKeysToExpand = (initialFolderName, parentFolderName, initial = []) => {
...
var init_CompositionSelector = __esm(() => {
  init_create_folder_tree();
  init_persist_open_folders();
  init_z_index();
  init_CompositionSelectorItem();
  init_CurrentComposition();
  init_InitialCompositionLoader();
  container7 = {
    display: "flex",
    flexDirection: "column",
    flex: 1,
...
var use_asset_drag_events_default;
var init_use_asset_drag_events = __esm(() => {
  use_asset_drag_events_default = useAssetDragEvents;
});
...
}, subscribeToFileExistenceWatcher = async ({
  file,
  clientId
}) => {
...
}, getProjectInfo = (signal) => {
  return callApi("/api/project-info", {}, signal);
}, callUpdateDefaultPropsApi = (compositionId, defaultProps, enumPaths) => {
...
}, canUpdateDefaultProps = (compositionId, readOnlyStudio) => {
  if (readOnlyStudio) {
...
var ASSET_ITEM_HEIGHT = 32, iconStyle2, itemStyle2, labelStyle3, revealIconStyle, AssetFolderItem = ({
  tabIndex,
  item,
  level,
  parentFolder,
...
}, AssetSelectorItem = ({ item, tabIndex, level, parentFolder }) => {
  const isMobileLayout = useMobileLayout();
  const [hovered, setHovered] = useState15(false);
...
var init_AssetSelectorItem = __esm(() => {
  init_mobile_layout();
  init_use_asset_drag_events();
  init_clipboard();
  init_file();
  init_folder();
  init_sidebar();
...
var container8, emptyState, label, list, AssetSelector = ({ readOnlyStudio }) => {
  const { tabIndex } = useZIndex();
...
var init_CompSelectorRef = __esm(() => {
  init_persist_open_folders();
  init_InitialCompositionLoader();
});
...
var tabsContainer, Tabs = ({ children, style }) => {
...
}, selectorButton, Tab = ({ children, onClick, style, selected }) => {
...
var container9, localStorageKey2 = "remotion.sidebarPanel", getSelectedPanel = () => {
  const panel = localStorage.getItem(localStorageKey2);
  if (panel === "assets") {
    return "assets";
  }
  return "compositions";
}, tabsContainer2, persistSelectedOptionsSidebarPanel = (panel) => {
  localStorage.setItem(localStorageKey2, panel);
}, explorerSidebarTabs, ExplorerPanel = ({ readOnlyStudio }) => {
...
var init_ExplorerPanel = __esm(() => {
  init_AssetSelector();
  init_CompositionSelector();
  init_CompSelectorRef();
  init_Tabs();
  container9 = {
    height: "100%",
    width: "100%",
  ...
  explorerSidebarTabs = createRef5();
});
...
var init_InitialCompositionLoader = __esm(() => {
  init_mobile_layout();
  init_folders();
  init_sidebar();
  init_CompositionSelector();
...
var init_restart_studio = () => {};

// src/components/ModalContainer.tsx
import { jsx as jsx40 } from "react/jsx-runtime";
var padding = 20, getMaxModalWidth = (width) => {
  return `min(calc(100vw - ${padding * 2}px), calc(${width}px - ${padding * 2}px))`;
}, getMaxModalHeight = (height) => {
  return `min(calc(100vh - ${padding * 2}px), calc(${height}px - ${padding * 2}px))`;
}, backgroundOverlay, panel, ModalContainer = ({ children, onEscape, onOutsideClick, noZIndex }) => {
...
var style, CancelButton = ({ onPress, ...props }) => {
  const { tabIndex } = useZIndex();
...
var container10, titleStyle, icon, ModalHeader = ({ title: title2, onClose }) => {
...
var container11, askAiModalRef, AskAiModal = () => {
...
var init_AskAiModal = __esm(() => {
  ...
  askAiModalRef = createRef6();
});

// src/icons/Checkmark.tsx
import { jsx as jsx44 } from "react/jsx-runtime";
var style2, Checkmark = () => /* @__PURE__ */ jsx44("svg", {
  focusable: "false",
  role: "img",
  viewBox: "0 0 512 512",
  style: style2,
...
var CONTROL_BUTTON_PADDING = 6, ControlButton = (props) => {
...
var container12, label2, Combobox = ({ values, selectedId, style: customStyle, title: title2 }) => {
...
var getCheckerboardBackgroundSize = (size) => `${size}px ${size}px`, getCheckerboardBackgroundPos = (size) => `0 0, ${size / 2}px 0, ${size / 2}px -${size / 2}px, 0px ${size / 2}px`, checkerboardBackgroundColor = (checkerboard) => {
  if (checkerboard) {
    return "white";
  }
  return "black";
}, checkerboardBackgroundImage = (checkerboard) => {
  if (checkerboard) {
    return `
     linear-gradient(
        45deg,
...
var init_checkerboard = __esm(() => {
  CheckerboardContext = createContext10({
...
var remotion_outputsBase, getSrcFromCanvasContent = (canvasContent) => {
...
}, getAssetMetadata = async (canvasContent, addTime) => {
...
var init_get_asset_metadata = __esm(() => {
  init_Preview();
  remotion_outputsBase = window.remotion_staticBase.replace("static", "outputs");
});
...
var INPUT_HORIZONTAL_PADDING = 8, aligner, RightAlignInput = ({ children }) => {
  return /* @__PURE__ */ jsx47("div", {
    style: aligner,
    children
  });
}, inputBaseStyle, getInputBorderColor = ({
  status,
  isFocused,
  isHovered
}) => status === "warning" ? WARNING_COLOR : status === "error" ? FAIL_COLOR : isFocused ? SELECTED_BACKGROUND : isHovered ? INPUT_BORDER_COLOR_HOVERED : INPUT_BORDER_COLOR_UNHOVERED, RemInputForwardRef = ({ status, rightAlign, ...props }, ref) => {
...
var init_RemInput = __esm(() => {
  ...
  RemotionInput = forwardRef(RemInputForwardRef);
});
...
var inputBaseStyle2, RemTextareaFRFunction = ({ status, ...props }, ref) => {
...
var msgStyle, FilePreview = ({ fileType, src, currentAsset, assetMetadata }) => {
  if (!assetMetadata) {
...
var msgStyle2, errMsgStyle, RenderPreview = ({ path, assetMetadata }) => {
...
var init_RenderPreview = __esm(() => {
  init_client_id();
  init_get_asset_metadata();
  init_FilePreview();
  init_Preview();
  msgStyle2 = {
    fontSize: 13,
...
var viewBox = 100, lines = 8, className = "__remotion_spinner_line", remotionSpinnerAnimation = "__remotion_spinner_animation", translated = "M 44 0 L 50 0 a 6 6 0 0 1 6 6 L 56 26 a 6 6 0 0 1 -6 6 L 50 32 a 6 6 0 0 1 -6 -6 L 44 6 a 6 6 0 0 1 6 -6 Z", Spinner = ({ size, duration }) => {
...
var msgStyle3, errMsgStyle2, StaticFilePreview = ({ currentAsset, assetMetadata }) => {
...
var init_StaticFilePreview = __esm(() => {
  init_client_id();
  init_FilePreview();
  init_Preview();
  msgStyle3 = {
...
var centeredContainer, label3, getPreviewFileType = (fileName) => {
  if (!fileName) {
    return "other";
  }
  ...
  return "other";
}, checkerboardSize = 49, containerStyle = (options) => {
  return {
...
}, VideoPreview = ({ canvasSize, contentDimensions, canvasContent, assetMetadata }) => {
...
}, CompWhenItHasDimensions = ({ contentDimensions, canvasSize, canvasContent, assetMetadata }) => {
...
}, PortalContainer = ({ scale, xCorrection, yCorrection, contentDimensions }) => {
...
var commonPreviewSizes, getPreviewSizeLabel = (previewSize) => {
  if (previewSize.size === "auto") {
    return "Fit";
  }
  return `${(previewSize.size * 100).toFixed(0)}%`;
}, accessibilityLabel = "Preview Size", comboStyle, getUniqueSizes = (size) => {
...
}, zoomableFileTypes, SizeSelector = () => {
...
var TimelineInOutContext, SetTimelineInOutContext, useTimelineInOutFramePosition = () => {
...
var init_in_out = __esm(() => {
  TimelineInOutContext = createContext11({});
  SetTimelineInOutContext = createContext11({
    setInAndOutFrames: () => {
...
].filter(NoReactInternals4.truthy).join(" "), style3, inOutHandles, defaultInOutValue, TimelineInOutPointToggle = () => {
...
var init_TimelineInOutToggle = __esm(() => {
  init_use_keybinding();
  init_timelineInOutPointer();
  init_in_out();
  init_ControlButton();
  style3 = {
    width: 16,
  ...
  inOutHandles = createRef7();
  defaultInOutValue = { inFrame: null, outFrame: null };
});

// src/error-overlay/remotion-overlay/ShortcutHint.tsx
import { useMemo as useMemo35 } from "react";
import { jsx as jsx58, jsxs as jsxs20 } from "react/jsx-runtime";
var cmdOrCtrlCharacter, container13, ShortcutHint = ({ keyToPress, cmdOrCtrl }) => {
...
var init_ShortcutHint = __esm(() => {
  init_use_keybinding();
  cmdOrCtrlCharacter = window.navigator.platform.startsWith("Mac") ? "⌘" : "Ctrl";
  container13 = {
    display: "inline-block",
    marginLeft: 6,
    opacity: 0.6,
...
var init_editor_guides = __esm(() => {
  EditorShowGuidesContext = createContext12({
...
var persistEditorShowRulersOption = (option) => {
  ...
  return item === "true";
}, EditorShowRulersContext, RULER_WIDTH = 20, MINIMUM_VISIBLE_CANVAS_SIZE = 50, PREDEFINED_RULER_SCALE_GAPS, MAXIMUM_PREDEFINED_RULER_SCALE_GAP = 5000, MINIMUM_RULER_MARKING_GAP_PX = 50;
var init_editor_rulers = __esm(() => {
  EditorShowRulersContext = createContext13({
...
var init_editor_zoom_gestures = __esm(() => {
  EditorZoomGesturesContext = createContext14({
...
var getGitSourceName = (gitSource) => {
  ...
  throw new Error("Unknown git source type");
}, getGitRefUrl = (gitSource, originalLocation) => {
  if (gitSource.type === "github") {
...
}, openOriginalPositionInEditor = async (originalPosition) => {
  await openInEditor({
...
var container14, ColorDot = ({ color }) => {
...
}, rotate, ICON_SIZE = 16, getFileMenu = ({
  readOnlyStudio,
  closeMenu,
  previewServerState
}) => {
...
}, useMenuStructure = (closeMenu, readOnlyStudio) => {
...
}, itemToSearchResult = (item, setSelectedModal, prefixes) => {
  if (item.subMenu) {
...
}, makeSearchResults = (actions, setSelectedModal) => {
...
var init_use_menu_structure = __esm(() => {
  init_restart_studio();
  init_AskAiModal();
  init_NotificationCenter();
  init_SizeSelector();
  init_TimelineInOutToggle();
  init_layout();
  init_ShortcutHint();
  init_Checkmark();
  init_canvas_ref();
...
var svgStyle, buttonStyle, OpenEditorButton = ({ type }) => {
...
var init_OpenEditorButton = __esm(() => {
  init_NotificationCenter();
  svgStyle = {
    width: 11,
    height: 11
...
var cwd, spinnerSize = 14, spinner, noSpinner, MenuBuildIndicator = () => {
...
var init_MenuBuildIndicator = __esm(() => {
  init_client_id();
  init_OpenEditorButton();
  init_Spinner();
  init_layout();
  cwd = {
    fontSize: 13,
...
var regexExtractLocation, regexValidFrame_Chrome, regexValidFrame_FireFox, parseError = async (error, contextLines) => {
  if (error === null) {
...
var init_parser = __esm(() => {
  regexExtractLocation = /\(?(.+?)(?::(\d+))?(?::(\d+))?\)?$/;
  regexValidFrame_Chrome = /^\s*(at|in)\s.+(:\d+)/;
  regexValidFrame_FireFox = /(^|@)\S+:\d+|.+line\s+\d+\s+>\s+(eval|Function).+/;
});
...
var getFileContents = async (fileName) => {
  ...
  return fileContents;
}, unmap = async (frames, contextLines) => {
...
var init_get_stack_frames = __esm(() => {
  init_parser();
  init_unmapper();
});

// src/error-overlay/react-overlay/listen-to-runtime-errors.ts
var CONTEXT_SIZE = 3, getErrorRecord = async (error) => {
...
var init_listen_to_runtime_errors = __esm(() => {
  init_get_stack_frames();
});

// src/components/Button.tsx
import { forwardRef as forwardRef3, useMemo as useMemo40 } from "react";
import { jsx as jsx65 } from "react/jsx-runtime";
var button, ButtonRefForwardFunction = ({
  children,
  onClick,
  title: title2,
  disabled,
...
var init_Button = __esm(() => {
  ...
  Button = forwardRef3(ButtonRefForwardFunction);
});
...
var DISCORD_LINK = "https://remotion.dev/discord", AskOnDiscord = ({ canHaveKeyboardShortcuts }) => {
...
var init_CalculateMetadataErrorExplainer = __esm(() => {
  init_styles();
  style4 = {
    borderRadius: 3,
    color: "white",
...
var fontSize = 24, lineHeight = 1.5, maxLines = 2, buttonSize = 32, maskImage = "linear-gradient(to bottom, white 60%, transparent)", container16, messageContainer, textContainer, moreLine, moreButton, ErrorMessage = ({ message }) => {
...
var title2, left, errName, row2, spacer, ErrorTitle = ({ name, message, symbolicating, canHaveDismissButton }) => {
...
var buttonStyle2, HelpLink = ({ canHaveKeyboardShortcuts, link }) => {
...
var initialState, reducer = (state, action) => {
  ...
  return state;
}, OpenInEditor = ({ stack, canHaveKeyboardShortcuts }) => {
...
var init_SearchGitHubIssues = __esm(() => {
  init_Button();
  init_use_keybinding();
  init_ShortcutHint();
});
...
var container17, frame, lineNumber, CodeFrame = ({ source, lineNumberWidth }) => {
...
var location, header, left2, fnName, StackElement = ({ s, lineNumberWidth, isFirst, defaultFunctionName }) => {
...
var stack, spacer2, ErrorDisplay = ({
  display,
  keyboardShortcuts,
  onRetry,
...
var init_ErrorDisplay = __esm(() => {
  init_layout();
  init_AskOnDiscord();
  init_CalculateMetadataErrorExplainer();
  init_ErrorTitle();
  init_HelpLink();
  init_OpenInEditor();
  init_Retry();
  init_SearchGitHubIssues();
  init_StackFrame();
  stack = {
    marginTop: 17,
    overflowX: "scroll",
...
var container18, errorWhileErrorStyle, ErrorLoader = ({
  error,
  keyboardShortcuts,
  onRetry,
  canHaveDismissButton,
...
var init_ErrorLoader = __esm(() => {
  init_listen_to_runtime_errors();
  init_ErrorDisplay();
  init_ErrorTitle();
  container18 = {
    width: "100%",
...
}, MUST_BE_INSIDE_CANVAS = 50, getEffectiveYTranslation = ({
  canvasSize,
  scale,
  compositionHeight,
  translation
...
var BASE, MIN_ZOOM = 0.05, MAX_ZOOM = 10, smoothenZoom = (input) => {
  return BASE ** (input - 1);
}, unsmoothenZoom = (input) => {
  if (input < 0) {
    return MAX_ZOOM;
  }
  return Math.min(MAX_ZOOM, Math.max(MIN_ZOOM, logN(input) + 1));
};
var init_smooth_zoom = __esm(() => {
  BASE = Math.E / 4;
});
...
var init_use_studio_canvas_dimensions = () => {};
...
var PADDING_FOR_EASY_DRAG = 4, GuideComp = ({ guide, canvasDimensions, scale }) => {
  const {
...
}, EditorGuides_default;
var init_EditorGuides = __esm(() => {
  init_use_studio_canvas_dimensions();
  init_editor_guides();
  init_Guide();
  EditorGuides_default = EditorGuides;
});
...
var originBlockStyles, EditorRulers = ({ contentDimensions, canvasSize, assetMetadata, containerRef }) => {
...
var init_use_is_ruler_visible = __esm(() => {
  init_editor_rulers();
});
...
var init_ResetZoomButton = __esm(() => {
  init_Button();
});
...
var container19, resetZoom, ZOOM_PX_FACTOR = 0.003, Canvas = ({ canvasContent, size: size2 }) => {
...
var init_Canvas = __esm(() => {
  ...
  init_EditorGuides();
  init_EditorRuler();
  init_use_is_ruler_visible();
  init_Preview();
  init_ResetZoomButton();
  init_layout();
  container19 = {
    flex: 1,
    display: "flex",
...
var init_RunningCalculateMetadata = __esm(() => {
  init_styles();
  init_Spinner();
  init_layout();
  loaderLabel = {
...
var container21, shadow, RefreshCompositionOverlay = () => {
...
var init_RefreshCompositionOverlay = __esm(() => {
  init_RunningCalculateMetadata();
  container21 = {
    justifyContent: "flex-end",
...
var container22, CanvasOrLoading = ({ size: size2 }) => {
...
}, loaderContainer, ErrorLoading = ({ error }) => {
  return /* @__PURE__ */ jsx89("div", {
...
var init_CanvasOrLoading = __esm(() => {
  init_ErrorLoader();
  init_timeline_zoom();
  init_Canvas();
  init_FramePersistor();
  init_RefreshCompositionOverlay();
  init_RunningCalculateMetadata();
  init_timeline_scroll_logic();
  init_ZoomPersistor();
  container22 = {
...
var init_CanvasIfSizeIsAvailable = __esm(() => {
  init_editor_rulers();
  init_CanvasOrLoading();
  init_use_is_ruler_visible();
});

// src/helpers/document-title.ts
import { NoReactInternals as NoReactInternals7 } from "remotion/no-react";
var currentItemName = null, unsavedProps = false, tabInactive = false, renderJobs, setCurrentCanvasContentId = (id) => {
  if (!id) {
    currentItemName = id;
    updateTitle();
    return;
  ...
  updateTitle();
}, setUnsavedProps = (unsaved) => {
  window.remotion_unsavedProps = unsaved;
  unsavedProps = unsaved;
}, setRenderJobs = (jobs) => {
  renderJobs = jobs;
  updateTitle();
}, productName = "Remotion Studio", suffix, updateTitle = () => {
  if (!currentItemName) {
...
}, getProgressInBrackets = (selectedCompositionId, jobs) => {
...
var TitleUpdater = () => {
  ...
  return null;
}, CurrentCompositionKeybindings = ({ readOnlyStudio }) => {
  const keybindings = useKeybinding();
...
var init_CurrentCompositionSideEffects = __esm(() => {
  init_client_id();
  init_document_title();
  init_use_keybinding();
  init_NotificationCenter();
...
var container23, buttonContainer, button2;
var init_MobilePanel = __esm(() => {
  init_z_index();
  init_portals();
  init_CancelButton();
  container23 = {
...
}, ZodContext, ZodProvider = ({ children }) => {
...
var init_get_zod_if_possible = __esm(() => {
  ZodContext = createContext15(null);
});
...
var VisualControlsTabActivatedContext, VisualControlsContext, visualControlRef, SetVisualControlsContext, VisualControlsProvider = ({ children }) => {
...
var init_VisualControls = __esm(() => {
  init_get_zod_if_possible();
  VisualControlsTabActivatedContext = createContext16(false);
  VisualControlsContext = createContext16({
    handles: {}
  });
  visualControlRef = createRef8();
  SetVisualControlsContext = createContext16({
    updateHandles: () => {
...
var init_save_default_props = __esm(() => {
  init_actions();
  init_calc_new_props();
});
...
var icon2, SchemaResetButton = ({ onClick }) => {
...
var init_SchemaResetButton = __esm(() => {
  init_InlineAction();
  icon2 = {
    height: 14,
    color: "currentColor"
...
var icon3, SchemaSaveButton = ({ onClick, disabled }) => {
...
var init_SchemaSaveButton = __esm(() => {
  init_InlineAction();
  icon3 = {
    height: 14,
    color: "currentColor"
...
var container24, GlobalPropsEditorUpdateButton = ({ compositionId, currentDefaultProps }) => {
...
var init_GlobalPropsEditorUpdateButton = __esm(() => {
  init_save_default_props();
  init_NotificationCenter();
  init_SchemaResetButton();
  init_SchemaSaveButton();
  container24 = {
    display: "inline-block",
    flexDirection: "row"
  };
...
}, style6, container25, label4, ValidationMessage = ({ message, align, type }) => {
...
var init_ValidationMessage = __esm(() => {
  init_layout();
  style6 = {
    width: 12,
    height: 12,
...
var container26, item, SegmentedControl = ({ items, needsWrapping }) => {
...
}, Item = ({ selected, onClick, children }) => {
...
var schemaLabel, jsonLabel, triangleStyle, ZodErrorMessages = ({ zodValidationResult, viewTab }) => {
...
var init_ZodErrorMessages = __esm(() => {
  init_ValidationMessage();
  init_layout();
  schemaLabel = {
    fontSize: 14,
    color: LIGHT_TEXT
...
var style7, scrollable, parseJSON = (str, schema) => {
  try {
...
var init_RenderModalJSONPropsEditor = __esm(() => {
  init_document_title();
  init_use_keybinding();
  init_Button();
  init_RemTextarea();
...
var explainer, errorExplanation, codeSnippet, errorContainer, openDocs = () => {
...
}, InvalidDefaultProps = ({ zodValidationResult }) => {
  return /* @__PURE__ */ jsxs45("div", {
...
}, InvalidSchema = ({ zodValidationResult, reset }) => {
  return /* @__PURE__ */ jsxs45("div", {
    style: errorContainer,
    children: [
      /* @__PURE__ */ jsx101("div", {
...
var init_SchemaErrorMessages = __esm(() => {
  init_Button();
  init_styles();
  init_layout();
  init_ZodErrorMessages();
...
var optionRow, label5, rightRow, input, fieldSetText, fieldsetLabel;
...
var SCHEMA_EDITOR_FIELDSET_PADDING = 10, AlreadyPaddedRightContext, Fieldset = ({ children, shouldPad }) => {
...
var init_Fieldset = __esm(() => {
  AlreadyPaddedRightContext = createContext17(false);
});

// src/components/RenderModal/InlineRemoveButton.tsx
import { useCallback as useCallback47 } from "react";
import { jsx as jsx103 } from "react/jsx-runtime";
var clearIcon, InlineRemoveButton = ({ onClick }) => {
...
var init_InlineRemoveButton = __esm(() => {
  init_InlineAction();
  clearIcon = {
    height: 14,
    color: "currentColor"
...
var DEFAULT_PROPS_PATH_CLASSNAME = "__remotion-default-props-editor-label", DEFAULT_PROPS_PATH_ACTIVE_CLASSNAME = "__remotion-default-props-editor-label-active", defaultPropsEditorScrollableAreaRef;
var init_scroll_to_default_props_path = __esm(() => {
  defaultPropsEditorScrollableAreaRef = React67.createRef();
});
...
var init_SchemaLabel = __esm(() => {
  init_layout();
  init_InlineRemoveButton();
  init_SchemaResetButton();
  init_SchemaSaveButton();
  init_scroll_to_default_props_path();
  compactStyles = {
    fontSize: 15,
    color: LIGHT_TEXT,
    fontFamily: "sans-serif",
...
var VERTICAL_GUIDE_HEIGHT = 24, line2, SchemaSeparationLine = () => {
  return /* @__PURE__ */ jsx106("div", {
    style: line2
  });
}, arraySeparationLine, SchemaArrayItemSeparationLine = ({ onChange, index, schema, isLast, showAddButton }) => {
...
var init_SchemaSeparationLine = __esm(() => {
  init_plus();
  init_get_zod_if_possible();
  init_layout();
  init_layout2();
...
var flex, SchemaVerticalGuide = ({ isRoot, children }) => {
...
var init_SchemaVerticalGuide = __esm(() => {
  init_SchemaSeparationLine();
  flex = {
    flex: 1
  };
});
...
var init_ZodArrayItemEditor = __esm(() => {
  init_get_zod_if_possible();
  init_ZodSwitch();
});
...
var arrow, arrowUp, arrowDown, InfoTooltip = ({ children, arrowDirection, backgroundColor }) => {
...
var icon4, container27, InfoBubble = ({ title: title3, children }) => {
...
var legend, stackTrace, stackTraceLabel, ZodFieldValidation = ({ localValue, path }) => {
...
var init_ZodFieldValidation = __esm(() => {
  init_layout();
  init_ValidationMessage();
  init_InfoBubble();
  legend = {
...
var RevisionContext, useLocalState = ({
  unsavedValue,
  schema,
  setValue,
  savedValue
...
var init_local_state = __esm(() => {
  RevisionContext = createContext18({
...
var init_ZodArrayEditor = __esm(() => {
  init_get_zod_if_possible();
  init_Fieldset();
  init_SchemaLabel();
  init_SchemaSeparationLine();
  init_SchemaVerticalGuide();
  init_ZodArrayItemEditor();
  init_ZodFieldValidation();
  init_local_state();
});
...
var size2 = 20, background, box, Checkbox = ({ checked, onChange, disabled, name }) => {
...
var fullWidth, ZodBooleanEditor = ({
  schema,
  jsonPath,
  value,
  setValue,
...
var init_ZodBooleanEditor = __esm(() => {
  init_Checkbox();
  init_Fieldset();
  init_SchemaLabel();
  init_local_state();
...
var init_InputDragger = __esm(() => {
  init_z_index();
  init_RemInput();
  InputDragger = React77.forwardRef(InputDraggerForwardRefFn);
});
...
var inputBaseStyle3, RemInputTypeColorForwardRef = ({ status, ...props }, ref) => {
...
var init_RemInputTypeColor = __esm(() => {
  init_z_index();
  init_RemInput();
  inputBaseStyle3 = {
    padding: 0,
  ...
  RemInputTypeColor = forwardRef4(RemInputTypeColorForwardRef);
});
...
var init_ZodColorEditor = __esm(() => {
  init_InputDragger();
  init_RemInput();
  init_RemInputTypeColor();
  init_get_zod_if_possible();
  init_layout();
  init_Fieldset();
  init_SchemaLabel();
...
var fullWidth3, explainer2, inputStyle, formatDate = (date) => {
...
var init_ZodDefaultEditor = __esm(() => {
  init_ZodSwitch();
});
...
var init_ZodEffectEditor = __esm(() => {
  init_get_zod_if_possible();
  init_Fieldset();
  init_ZodFieldValidation();
  init_ZodSwitch();
...
var init_ZodMatrixEditor = __esm(() => {
  init_get_zod_if_possible();
  init_Fieldset();
  init_SchemaLabel();
  init_SchemaSeparationLine();
...
var fullWidth5, emptyLabel, wideEmptyLabel, ZonNonEditableValue = ({ jsonPath, label: label6, showSaveButton, saving, mayPad }) => {
...
var init_ZodNonEditableValue = __esm(() => {
  init_Fieldset();
  init_SchemaLabel();
  fullWidth5 = {
    width: "100%"
...
var labelStyle4, checkBoxWrapper, ZodOrNullishEditor = ({
  jsonPath,
  schema,
  setValue,
  onSave,
...
var init_ZodOrNullishEditor = __esm(() => {
  init_Checkbox();
  init_get_zod_if_possible();
  init_layout();
  init_Fieldset();
...
var init_ZodNullableEditor = __esm(() => {
  init_ZodOrNullishEditor();
});
...
var fullWidth6, getMinValue = (schema) => {
...
var init_ZodNumberEditor = __esm(() => {
  init_InputDragger();
  init_Fieldset();
  init_SchemaLabel();
  init_ZodFieldValidation();
...
var init_ZodOptionalEditor = __esm(() => {
  init_ZodOrNullishEditor();
});
...
var container29, ZodStaticFileEditor = ({
  schema,
  jsonPath,
  setValue,
  defaultValue,
...
var init_ZodStaticFileEditor = __esm(() => {
  init_Checkmark();
  init_ComboBox();
  init_get_zod_if_possible();
  init_Fieldset();
...
var fullWidth7, ZodStringEditor = ({
  jsonPath,
  value,
  setValue,
  showSaveButton,
...
var init_ZodStringEditor = __esm(() => {
  init_RemInput();
  init_get_zod_if_possible();
  init_Fieldset();
  init_SchemaLabel();
...
var fullWidth8, textareaStyle, ZodTextareaEditor = ({
  jsonPath,
  value,
  setValue,
  showSaveButton,
...
var init_ZodTextareaEditor = __esm(() => {
  init_RemTextarea();
  init_get_zod_if_possible();
  init_Fieldset();
  init_SchemaLabel();
...
var init_ZodTupleItemEditor = __esm(() => {
  init_get_zod_if_possible();
  init_ZodSwitch();
});
...
var init_ZodUnionEditor = __esm(() => {
  init_get_zod_if_possible();
  init_ZodNonEditableValue();
  init_ZodOrNullishEditor();
});
...
var init_ZodSwitch = __esm(() => {
  init_get_zod_if_possible();
  init_ZodArrayEditor();
  init_ZodBooleanEditor();
  init_ZodColorEditor();
  init_ZodDateEditor();
  init_ZodDefaultEditor();
  init_ZodDiscriminatedUnionEditor();
  init_ZodEffectEditor();
  init_ZodEnumEditor();
  init_ZodMatrixEditor();
  init_ZodNonEditableValue();
  init_ZodNullableEditor();
  init_ZodNumberEditor();
  init_ZodObjectEditor();
  init_ZodOptionalEditor();
  init_ZodStaticFileEditor();
  init_ZodStringEditor();
  init_ZodTextareaEditor();
  init_ZodTupleEditor();
  init_ZodUnionEditor();
});
...
var init_ZodObjectEditor = __esm(() => {
  init_get_zod_if_possible();
  init_layout2();
  init_Fieldset();
  init_SchemaLabel();
...
var init_SchemaEditor = __esm(() => {
  init_document_title();
  init_use_keybinding();
  init_get_zod_if_possible();
  init_SchemaErrorMessages();
  init_ZodObjectEditor();
  init_local_state();
  init_scroll_to_default_props_path();
  scrollable2 = {
...
var style8, triangleStyle2, WarningTriangle2 = (props) => {
...
}, WarningIndicatorButton = ({ setShowWarning, showWarning, warningCount }) => {
...
var init_WarningIndicatorButton = __esm(() => {
  init_caret();
  init_layout();
  style8 = {
    fontSize: 12,
...
var defaultTypeCanSaveState, getInputPropsWarning = ({
  cliProps,
  propsEditType
}) => {
...
var init_get_render_modal_warnings = __esm(() => {
...
var errorExplanation2, explainer3, outer, controlContainer, tabWrapper, persistanceKey = "remotion.show-render-modalwarning", getPersistedShowWarningState = () => {
...
var init_DataEditor = __esm(() => {
  ...
  init_get_zod_if_possible();
  init_layout();
  init_RenderModalJSONPropsEditor();
  init_SchemaEditor();
  init_SchemaErrorMessages();
  init_WarningIndicatorButton();
  init_get_render_modal_warnings();
  errorExplanation2 = {
    fontSize: 14,
    color: LIGHT_TEXT,
    fontFamily: "sans-serif",
...
var revealIconStyle2, supportsCopyingToClipboard = (job) => {
  if (job.status !== "done") {
    return false;
  }
  if (job.type !== "still") {
  ...
  return false;
}, RenderQueueCopyToClipboard = ({ job }) => {
...
var init_RenderQueueCopyToClipboard = __esm(() => {
  init_get_asset_metadata();
  init_clipboard();
  init_InlineAction();
  init_NotificationCenter();
...
var outputLocation, RenderQueueError = ({ job }) => {
...
var init_RenderQueueError = __esm(() => {
  init_modals();
  init_z_index();
  init_item_style();
  outputLocation = {
...
var init_RenderQueueItemCancelButton = __esm(() => {
  init_InlineAction();
  init_NotificationCenter();
  init_actions();
});
...
var RENDER_STATUS_INDICATOR_SIZE = 16, STROKE_WIDTH = 3, container30, CircularProgress = ({ progress }) => {
...
var iconStyle3, invisibleStyle, RenderQueueItemStatus = ({ job }) => {
...
var init_RenderQueueItemStatus = __esm(() => {
  init_modals();
...
var init_RenderQueueOpenInFolder = __esm(() => {
  init_folder();
  init_InlineAction();
  init_NotificationCenter();
  init_actions();
...
var init_RenderQueueOutputName = __esm(() => {
  init_item_style();
});
...
var outputLocation2, RenderQueueProgressMessage = ({ job }) => {
  if (job.status !== "running") {
    throw new Error("should not have rendered this component");
  }
...
var init_RenderQueueProgressMessage = __esm(() => {
  init_modals();
  init_z_index();
  init_item_style();
  outputLocation2 = {
...
var init_RenderQueueRemoveItem = __esm(() => {
  init_InlineAction();
  init_NotificationCenter();
  init_actions();
});
...
var init_RenderQueueRepeat = __esm(() => {
  init_mobile_layout();
  init_retry_payload();
  init_modals();
  init_sidebar();
...
var container31, title3, right, subtitle2, SELECTED_CLASSNAME = "__remotion_selected_classname", RenderQueueItem = ({ job, selected }) => {
...
var init_RenderQueueItem = __esm(() => {
  init_layout();
  init_RenderQueueCopyToClipboard();
  init_RenderQueueError();
  init_RenderQueueItemCancelButton();
  init_RenderQueueItemStatus();
  init_RenderQueueOpenInFolder();
  init_RenderQueueOutputName();
  init_RenderQueueProgressMessage();
  init_RenderQueueRemoveItem();
  init_RenderQueueRepeat();
  container31 = {
    padding: 12,
    display: "flex",
    flexDirection: "row",
...
var separatorStyle, errorExplanation3, explainer4, renderQueue, RenderQueue = () => {
...
var init_RenderQueue = __esm(() => {
  init_client_id();
  init_layout();
  init_RenderQueueItem();
  init_context();
  separatorStyle = {
    borderBottom: `1px solid ${BORDER_COLOR}`
  };
...
var row3, badge, RendersTab = ({ selected, onClick }) => {
...
var container32, ClickableFileName = ({
  originalFileName
}) => {
...
var init_ClickableFileName = __esm(() => {
  init_Fieldset();
  container32 = {
...
var init_VisualControlHandleHeader = __esm(() => {
  init_ClickableFileName();
});
...
`));
  ...
  return null;
}, getLocationOfFunctionCall = (stack2, functionName) => {
  if (!stack2) {
    return null;
  }
  const parsed = parseStack(stack2.split(`
...
var init_get_location_of_sequence = __esm(() => {
  init_parser();
});

// src/components/Timeline/TimelineStack/get-stack.ts
import { SourceMapConsumer as SourceMapConsumer2 } from "source-map";
var waiters, sourceMapConsumerCache, isCreating, getSourceMapCache = async (fileName) => {
  ...
  return map;
}, getOriginalLocationFromStack = async (stack2, type) => {
...
var init_get_stack = __esm(() => {
  init_get_source_map();
  init_get_location_of_sequence();
  waiters = [];
...
var init_get_original_stack_trace = __esm(() => {
  init_get_stack();
});
...
var init_VisualControlHandle = __esm(() => {
  init_VisualControls();
  init_NotificationCenter();
  init_ZodSwitch();
  init_local_state();
  ...
  init_get_zod_if_possible();
  init_layout();
  init_VisualControlHandleHeader();
  init_get_original_stack_trace();
});
...
var container33, VisualControlsContent = () => {
...
var init_VisualControlsContent = __esm(() => {
  init_VisualControls();
  init_SchemaSeparationLine();
  init_VisualControlHandle();
  container33 = {
    overflowY: "auto"
  };
});
...
var localStorageKey3 = "remotion.sidebarPanel", getSelectedPanel2 = (readOnlyStudio) => {
  if (readOnlyStudio) {
    return "input-props";
  }
  ...
  return "input-props";
}, tabsContainer3, persistSelectedOptionsSidebarPanel2 = (panel2) => {
  localStorage.setItem(localStorageKey3, panel2);
}, optionsSidebarTabs, OptionsPanel = ({ readOnlyStudio }) => {
...
var init_OptionsPanel = __esm(() => {
  init_mobile_layout();
  init_VisualControls();
  init_GlobalPropsEditorUpdateButton();
  init_DataEditor();
  init_RenderQueue();
  init_RendersTab();
  init_Tabs();
  init_VisualControlsContent();
  tabsContainer3 = {
    backgroundColor: BACKGROUND
  };
  optionsSidebarTabs = createRef9();
});

// src/state/loop.ts
var key = "remotion.loop", persistLoopOption = (option) => {
...
var accessibilityLabel2, CheckboardToggle = () => {
...
var init_CheckboardToggle = __esm(() => {
  init_use_keybinding();
  init_checkerboard();
  init_ControlButton();
  accessibilityLabel2 = [
...
var label6, pushWithMaxSize = (arr, value, maxSize) => {
  arr.push(value);
  return arr.slice(-maxSize);
}, FpsCounter = ({ playbackSpeed }) => {
...
var accessibilityLabel3, FullScreenToggle = () => {
  const keybindings = useKeybinding();
...
var init_FullscreenToggle = __esm(() => {
  init_use_keybinding();
  init_canvas_ref();
  init_ControlButton();
  accessibilityLabel3 = [
...
var accessibilityLabel4 = "Loop video", LoopToggle = ({ loop, setLoop }) => {
...
var init_LoopToggle = __esm(() => {
  init_ControlButton();
});

// src/icons/media-volume.tsx
import { jsx as jsx162 } from "react/jsx-runtime";
var size3 = 22, VolumeOffIcon = () => {
...
var init_media_volume = () => {};

// src/state/mute.ts
var key2 = "remotion.mute", persistMuteOption = (option) => {
...
var backStyle, forwardBackStyle, iconButton, PlayPause = ({ playbackRate, loop, bufferStateDelayInMilliseconds }) => {
  const { inFrame, outFrame } = useTimelineInOutFramePosition();
...
var init_PlayPause = __esm(() => {
  init_is_current_selected_still();
  init_use_keybinding();
  init_jump_to_start();
  init_pause();
  init_play();
...
var init_PlaybackKeyboardShortcutsManager = __esm(() => {
  init_use_keybinding();
});

// src/state/playbackrate.ts
var key3 = "remotion.playbackrate", persistPlaybackRate = (option) => {
...
var init_PlaybackRatePersistor = () => {};
...
var commonPlaybackRates, getPlaybackRateLabel = (playbackRate) => {
  return `${playbackRate}x`;
}, accessibilityLabel5 = "Change the playback rate", comboStyle2, PlaybackRateSelector = ({ playbackRate, setPlaybackRate }) => {
...
var init_PlaybackRateSelector = __esm(() => {
  init_is_current_selected_still();
  init_Checkmark();
  init_ControlButton();
  init_ComboBox();
...
var button3, label7, RenderButton = () => {
  const { inFrame, outFrame } = useTimelineInOutFramePosition();
...
var container34, buttonStyle3, iconStyle4, TimelineZoomControls = () => {
...
var init_TimelineZoomControls = __esm(() => {
  init_is_current_selected_still();
  init_minus();
  init_plus();
  init_timeline_zoom();
...
var container35, mobileContainer, scrollIndicatorLeft, scrollIndicatorRight, sideContainer, padding2, PreviewToolbar = ({ readOnlyStudio, bufferStateDelayInMilliseconds }) => {
...
var init_PreviewToolbar = __esm(() => {
  init_is_current_selected_still();
  init_mobile_layout();
  init_CheckboardToggle();
  init_FpsCounter();
  init_FullscreenToggle();
  init_LoopToggle();
  init_MuteToggle();
  init_PlayPause();
  init_PlaybackKeyboardShortcutsManager();
  init_PlaybackRatePersistor();
  init_PlaybackRateSelector();
  init_RenderButton();
  init_SizeSelector();
  init_TimelineZoomControls();
  init_TimelineInOutToggle();
  init_layout();
  container35 = {
    display: "flex",
...
var localStorageKey4 = (id) => `remotion.editor.timelineFlex.${id}`, persistTimelineFlex = (value, id) => {
...
var SplitterContext;
var init_SplitterContext = __esm(() => {
  SplitterContext = React115.createContext({
    flexValue: 1,
    ref: { current: null },
    setFlexValue: () => {
      return;
...
var containerRow, containerColumn, SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
...
var init_SplitterContainer = __esm(() => {
...
var init_SplitterElement = __esm(() => {
  init_SplitterContext();
});
...
var SPLITTER_HANDLE_SIZE = 3, containerRow2, containerColumn2, SplitterHandle = ({ allowToCollapse, onCollapse }) => {
...
var container36, row4, useResponsiveSidebarStatus = () => {
...
}, TopPanel = ({ readOnlyStudio, onMounted, drawRef: drawRef2, bufferStateDelayInMilliseconds }) => {
...
var init_TopPanel = __esm(() => {
  init_mobile_layout();
  init_use_breakpoint();
  init_editor_rulers();
  init_sidebar();
  init_CanvasIfSizeIsAvailable();
  init_CurrentCompositionSideEffects();
  init_use_is_ruler_visible();
  init_ExplorerPanel();
  init_MobilePanel();
  init_OptionsPanel();
  init_PreviewToolbar();
  init_SplitterContainer();
  init_SplitterElement();
  init_SplitterHandle();
  container36 = {
    height: "100%",
    width: "100%",
...
var style9, SidebarCollapserControls = () => {
...
var init_SidebarCollapserControls = __esm(() => {
  init_ShortcutHint();
  init_use_keybinding();
  init_sidebar();
  init_InlineAction();
...
var row5, flex2, MenuToolbar = ({ readOnlyStudio }) => {
...
var init_MenuToolbar = __esm(() => {
  init_mobile_layout();
  init_use_menu_structure();
  init_MenuItem();
  init_MenuBuildIndicator();
  init_SidebarCollapserControls();
  init_UpdateCheck();
  init_layout();
  row5 = {
    alignItems: "center",
...
}, getTimelineVisibleStart = (sequence, sequences) => {
...
}, getTimelineVisibleDuration = (sequence, sequences) => {
...
var MAX_TIMELINE_TRACKS, MAX_TIMELINE_TRACKS_NOTICE_HEIGHT = 24, container37, MaxTimelineTracksReached = () => {
...
var init_MaxTimelineTracks = __esm(() => {
  MAX_TIMELINE_TRACKS = typeof process.env.MAX_TIMELINE_TRACKS === "undefined" || process.env.MAX_TIMELINE_TRACKS === null ? DEFAULT_TIMELINE_TRACKS : Number(process.env.MAX_TIMELINE_TRACKS);
  container37 = {
...
var areaHighlight, inMarkerAreaRef, outMarkerAreaRef, TimelineInOutPointer = () => {
  const { inFrame, outFrame } = useTimelineInOutFramePosition();
...
var init_TimelineInOutPointer = __esm(() => {
  init_get_left_of_timeline_slider();
  init_in_out();
  init_TimelineWidthProvider();
  areaHighlight = {
  ...
  inMarkerAreaRef = createRef10();
  outMarkerAreaRef = createRef10();
});
...
var line3, inPointerHandle, outPointerHandle, InnerTimelineInOutPointerHandle = ({ atFrame, dragging, timelineWidth, type }) => {
...
var init_TimelineInOutPointerHandle = __esm(() => {
  init_get_left_of_timeline_slider();
  init_TimelineWidthProvider();
  line3 = {
    height: "100%",
  ...
  inPointerHandle = createRef11();
  outPointerHandle = createRef11();
});
...
var inner, container38, style10, getClientXWithScroll = (x) => {
...
var init_TimelineDragHandler = __esm(() => {
  init_get_left_of_timeline_slider();
  init_in_out();
  init_timeline_zoom();
  init_z_index();
  ...
  init_TimelineInOutToggle();
  init_TimelineInOutPointer();
  init_TimelineInOutPointerHandle();
  init_TimelineSlider();
  init_TimelineWidthProvider();
  init_timeline_refs();
  init_timeline_scroll_logic();
...
var eyeIcon, speakerIcon, container39, layerPointedDown = null, TimelineLayerEye = ({ onInvoked, hidden, type }) => {
...
var init_TimelineLayerEye = __esm(() => {
  eyeIcon = {
    width: 12,
    color: "currentColor",
    pointerEvents: "none"
...
var SPACING = 5, outer2, space, TimelineListItem = ({ nestedDepth, sequence, isCompact }) => {
...
var init_TimelineListItem = __esm(() => {
  init_TimelineLayerEye();
  init_TimelineStack();
  outer2 = {
...
var text, time, frameStyle, TimeValue = () => {
...
var TIMELINE_TIME_INDICATOR_HEIGHT = 39, container40, tick, secondTick, tickLabel, timeValue, TimelineTimePlaceholders = () => {
...
}, Inner3 = ({ windowWidth, durationInFrames, fps }) => {
...
var init_TimelineTimeIndicators = __esm(() => {
  init_SplitterHandle();
  init_TimeValue();
  init_TimelineWidthProvider();
  init_timeline_refs();
...
var container41, TimelineList = ({ timeline }) => {
...
var init_TimelineList = __esm(() => {
  init_TimelineListItem();
  init_TimelineTimeIndicators();
  container41 = {
    flex: 1,
    background: BACKGROUND
  };
...
var lastTimelinePositionWhileScrolling = null, TimelinePlayCursorSyncer = () => {
...
var init_TimelinePlayCursorSyncer = __esm(() => {
  init_timeline_zoom();
  init_timeline_refs();
  init_timeline_scroll_logic();
});
...
var outer3, TimelineScrollable = ({ children }) => {
...
var init_TimelineScrollable = __esm(() => {
  init_timeline_refs();
  outer3 = {
    width: "100%",
    height: "100%",
...
var SEQUENCE_BORDER_WIDTH = 1, getWidthOfTrack = ({
  durationInFrames,
  lastFrame,
  windowWidth,
  spatialDuration,
...
var init_get_timeline_sequence_layout = () => {};

// src/components/AudioWaveformBar.tsx
import { useMemo as useMemo104 } from "react";
import { jsx as jsx192 } from "react/jsx-runtime";
var WAVEFORM_BAR_LENGTH = 2, WAVEFORM_BAR_MARGIN = 1, container42, AudioWaveformBar = ({ amplitude }) => {
...
var container43, errorMessage, canvasStyle, AudioWaveform = ({
  src,
  startFrom,
  durationInFrames,
  visualizationWidth,
...
var init_AudioWaveform = __esm(() => {
  init_AudioWaveformBar();
  container43 = {
    display: "flex",
    flexDirection: "row",
    alignItems: "flex-end",
...
var width, icon5, Icon = () => /* @__PURE__ */ jsx194("svg", {
  viewBox: "0 0 512 512",
  style: icon5,
...
}), topLine, bottomLine, topContainer, centerContainer, bottomContainer, LoopedIndicator = () => {
...
var init_LoopedIndicator = __esm(() => {
  width = {
    width: 30,
    flexDirection: "row",
    display: "flex",
...
var row6, LoopedTimelineIndicator = ({ loops }) => {
...
var init_LoopedTimelineIndicators = __esm(() => {
  init_layout();
  init_LoopedIndicator();
  row6 = {
    flexDirection: "row"
  };
});
...
var relativeFrameStyle, TimelineSequenceFrame = ({ roundedFrame, premounted }) => {
  return /* @__PURE__ */ jsx196("div", {
    style: relativeFrameStyle,
    children: premounted ? "0 (Premounted)" : roundedFrame
  });
};
var init_TimelineSequenceFrame = __esm(() => {
  relativeFrameStyle = {
    fontSize: 11,
    fontFamily: "Arial, Helvetica, sans-serif",
    color: "white",
...
var containerStyle2, svgStyle2, pathStyle, TimelineVideoInfo = ({ src }) => {
...
var init_TimelineVideoInfo = __esm(() => {
  containerStyle2 = {
...
var AUDIO_GRADIENT = "linear-gradient(rgb(16 171 58), rgb(43 165 63) 60%)", VIDEO_GRADIENT = "linear-gradient(to top, #8e44ad, #9b59b6)", TimelineSequence = ({ s }) => {
...
var init_TimelineSequence = __esm(() => {
  init_get_timeline_sequence_layout();
  init_AudioWaveform();
  init_LoopedTimelineIndicators();
  init_TimelineSequenceFrame();
  init_TimelineVideoInfo();
  init_TimelineWidthProvider();
});
...
var content, timelineContent, TimelineTracks = ({ timeline, hasBeenCut }) => {
...
var init_TimelineTracks = __esm(() => {
  init_MaxTimelineTracks();
  init_TimelineSequence();
  init_TimelineTimeIndicators();
  content = {
...
var init_Timeline = __esm(() => {
  init_calculate_timeline();
  init_SplitterContainer();
  init_SplitterElement();
  init_SplitterHandle();
  init_MaxTimelineTracks();
  init_TimelineDragHandler();
  init_TimelineInOutPointer();
  init_TimelineList();
  init_TimelinePlayCursorSyncer();
  init_TimelineScrollable();
  init_TimelineSlider();
  init_TimelineTimeIndicators();
  init_TimelineTracks();
  init_TimelineWidthProvider();
...
var noop3 = () => {
  return;
}, container45, EditorContent = ({ readOnlyStudio, children }) => {
  const isStill = useIsStill();
...
var init_GlobalKeybindings = __esm(() => {
  init_use_keybinding();
  init_checkerboard();
  init_modals();
  init_AskAiModal();
...
var init_install_package = () => {};

// src/components/InstallablePackage.tsx
import { jsx as jsx202, jsxs as jsxs100 } from "react/jsx-runtime";
var FONT_SIZE = 13, InstallablePackageComp = ({ isInstalled, pkg, link, description }) => {
...
var content2, ModalFooterContainer = ({ children }) => {
...
var init_DismissableModal = __esm(() => {
  init_modals();
  init_ModalContainer();
});
...
var container46, text2, InstallPackageModal = ({ packageManager }) => {
...
var init_InstallPackage = __esm(() => {
  ...
  init_use_keybinding();
  init_Checkbox();
  init_InstallablePackage();
  init_ModalButton();
  init_ModalFooter();
  init_ModalHeader();
  init_DismissableModal();
  init_layout();
  container46 = {
    padding: 20,
    maxHeight: 400,
...
var loaderContainer2, loaderLabel2, ResolvedCompositionContext, ResolveCompositionBeforeModal = ({ compositionId, children }) => {
...
var init_ResolveCompositionBeforeModal = __esm(() => {
  init_styles();
  init_RunningCalculateMetadata();
  init_layout();
  loaderContainer2 = {
  ...
  ResolvedCompositionContext = React143.createContext(null);
});
...
var content3, DeleteCompositionLoaded = ({ compositionId }) => {
...
var init_DeleteComposition = __esm(() => {
  init_styles();
  init_ModalFooter();
  init_ModalHeader();
  init_ResolveCompositionBeforeModal();
  init_CodemodFooter();
  init_DismissableModal();
  content3 = {
    padding: 16,
...
var validateCompositionName = (compName, compositions) => {
  ...
  return null;
}, validateCompositionDimension = (dimension, value) => {
  if (Number(value) % 2 !== 0) {
  ...
  return null;
}, validateCompositionDuration = (value) => {
  if (value % 1 !== 0) {
...
var init_validate_new_comp_data = () => {};
...
var init_NewCompDuration = __esm(() => {
  init_validate_new_comp_data();
  init_layout2();
  init_layout();
  init_InputDragger();
  init_ValidationMessage();
...
var content4, comboBoxStyle, DuplicateCompositionLoaded = ({ initialType }) => {
...
}, DuplicateComposition = ({ compositionId, compositionType }) => {
...
var init_DuplicateComposition = __esm(() => {
  init_validate_new_comp_data();
  init_ModalFooter();
  init_ModalHeader();
  init_ResolveCompositionBeforeModal();
...
var content5, RenameCompositionLoaded = () => {
...
var init_RenameComposition = __esm(() => {
  init_validate_new_comp_data();
  init_ModalFooter();
  init_ModalHeader();
  init_ResolveCompositionBeforeModal();
...
var left3, key4, right2, container47, title4, keyboardShortcutsDisabled, ul, li, KeyboardShortcutsExplainer = () => {
...
var init_KeyboardShortcutsExplainer = __esm(() => {
  init_ShortcutHint();
  init_use_keybinding();
  init_keys();
  init_layout();
...
var container48, MODE_TO_STRING, QuickSwitcherNoResults = ({ query, mode }) => {
...
var container49, label8, searchLabel, iconStyle6, labelContainer, QuickSwitcherResult = ({ result, selected }) => {
...
var init_QuickSwitcherResult = __esm(() => {
  init_use_keybinding();
  init_still();
  init_video();
  init_layout();
...
var ALGOLIA_API_KEY = "3e42dbd4f895fe93ff5cf40d860c4a85", ALGOLIA_APPLICATION_ID = "PLSDUOL1CA", AGOLIA_SEARCH_URL = "https://plsduol1ca-dsn.algolia.net/1/indexes/*/queries", algoliaSearch = async (query) => {
...
}, splitMatchIntoTitleAndSubtitle = (match) => {
...
var input2, modeSelector, modeItem, modeInactive, modeActive, content6, loopIndex = (index, length) => {
  if (index < 0) {
    index += length;
  }
  return index % length;
...
}, QuickSwitcherContent = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
...
var init_QuickSwitcherContent = __esm(() => {
  init_use_keybinding();
  init_use_menu_structure();
  init_modals();
  init_InitialCompositionLoader();
  init_KeyboardShortcutsExplainer();
  init_RemInput();
  init_layout();
  init_AlgoliaCredit();
  init_NoResults();
  init_QuickSwitcherResult();
  init_algolia_search();
  input2 = {
    width: "100%"
  };
...
}, QuickSwitcher_default;
var init_QuickSwitcher = __esm(() => {
  init_DismissableModal();
  init_QuickSwitcherContent();
  QuickSwitcher_default = QuickSwitcher;
});
...
}, envVariablesArrayToObject = (envVariables) => {
...
var init_render_modal_sections = () => {};
...
var selectorButton2, VerticalTab = ({ children, onClick, style: style11, selected }) => {
...
var svgStyle3, copiedStyle, buttonStyle6, CliCopyButton = ({
  valueToCopy
}) => {
...
var container50, padding3, title5, description, link2, infoRow, infoRowLabel, flexSpacer, copyWrapper, OptionExplainer = ({ option }) => {
...
var init_OptionExplainer = __esm(() => {
  init_MenuDivider();
  init_layout();
  init_CliCopyButton();
  container50 = {
...
var init_OptionExplainerBubble = __esm(() => {
  init_InfoBubble();
  init_OptionExplainer();
});
...
var init_NumberSetting = __esm(() => {
  init_InputDragger();
  init_RemInput();
  init_layout();
  init_OptionExplainerBubble();
  init_layout2();
});
...
}, CrfSetting = ({ crf, setCrf, min, max, option }) => {
...
var clearIcon2, InlineEyeButton = ({ onClick, enabled }) => {
...
var input3, validationStyle, EnvInput = ({
  onEnvKeyChange,
  onEnvValChange,
  envKey,
  envVal,
...
var title6, container51, button4, RenderModalEnvironmentVariables = ({ envVariables, setEnvVariables }) => {
...
var init_RenderModalEnvironmentVariables = __esm(() => {
  init_Button();
  init_layout();
  init_EnvInput();
  title6 = {
...
var hrStyle, RenderModalHr = () => {
  return /* @__PURE__ */ jsx234("div", {
    style: hrStyle
  });
};
var init_RenderModalHr = __esm(() => {
  hrStyle = {
    margin: "0 0 0 0",
    padding: "0 0 0 0",
    border: "none",
...
var container52, RenderModalAdvanced = ({
  renderMode,
  maxConcurrency,
  minConcurrency,
  setConcurrency,
...
var init_RenderModalAdvanced = __esm(() => {
  init_Checkmark();
  init_Checkbox();
  init_ComboBox();
  init_RemInput();
  ...
  init_NumberSetting();
  init_OptionExplainerBubble();
  init_RenderModalEnvironmentVariables();
  init_RenderModalHr();
  init_layout2();
  container52 = {
    flex: 1,
...
var init_EnforceAudioTrackSetting = __esm(() => {
  init_Checkbox();
  init_layout();
  init_OptionExplainerBubble();
  init_layout2();
...
var init_use_file_existence = __esm(() => {
  init_actions();
  init_client_id();
});
...
var init_RenderModalOutputName = __esm(() => {
  init_RemInput();
  init_ValidationMessage();
  init_layout();
  init_layout2();
...
}, SeparateAudioOption = ({ separateAudioTo, setSeparateAudioTo, audioCodec, outName }) => {
...
var init_SeparateAudioOption = __esm(() => {
  init_use_file_existence();
  init_Checkbox();
  init_layout();
  init_OptionExplainerBubble();
  init_RenderModalOutputName();
  init_layout2();
});
...
var container53, RenderModalAudio = ({
  muted,
  setMuted,
  renderMode,
  enforceAudioTrack,
...
var init_RenderModalAudio = __esm(() => {
  init_Checkmark();
  init_Checkbox();
  init_ComboBox();
  init_RemInput();
  init_layout();
  init_EnforceAudioTrackSetting();
  init_MutedSetting();
  init_OptionExplainerBubble();
  init_RenderModalHr();
  init_SeparateAudioOption();
  init_layout2();
  container53 = {
    flex: 1,
    overflowY: "auto"
...
var container54, sliderRange, MultiRangeSlider = ({
  min,
  max,
  start,
  end,
...
var container55, RenderModalBasic = ({
  renderMode,
  imageFormatOptions,
  outName,
  codec,
...
var init_RenderModalBasic = __esm(() => {
  init_use_file_existence();
  init_Checkmark();
  init_Checkbox();
  init_ComboBox();
...
var min = 0, NumberOfLoopsSetting = ({ numberOfGifLoops, setNumberOfGifLoops }) => {
...
var init_NumberOfLoopsSetting = __esm(() => {
  init_InputDragger();
  init_RemInput();
  init_layout2();
});
...
var container56, RenderModalGif = ({
  everyNthFrame,
...
var init_RenderModalGif = __esm(() => {
  init_Checkbox();
  init_layout();
  init_NumberOfLoopsSetting();
  init_NumberSetting();
  init_OptionExplainerBubble();
  init_layout2();
  container56 = {
...
var MIN_JPEG_QUALITY = 1, MAX_JPEG_QUALITY = 100, JpegQualitySetting = ({ jpegQuality, setJpegQuality }) => {
...
var init_JpegQualitySetting = __esm(() => {
  init_NumberSetting();
});

// src/components/RenderModal/ScaleSetting.tsx
import { jsx as jsx247 } from "react/jsx-runtime";
var MIN_SCALE = 0.1, MAX_SCALE = 10, ScaleSetting = ({ scale, setScale }) => {
...
var qualityControlModes, container57, RenderModalPicture = ({
  renderMode,
  scale,
  setScale,
  pixelFormat,
...
var init_RenderModalPicture = __esm(() => {
  init_Checkmark();
  init_Checkbox();
  init_ComboBox();
  init_RemInput();
  ...
  init_layout();
  init_CrfSetting();
  init_JpegQualitySetting();
  init_OptionExplainerBubble();
  init_RenderModalHr();
  init_ScaleSetting();
  init_layout2();
  qualityControlModes = ["crf", "bitrate"];
  container57 = {
    flex: 1,
    overflowY: "auto"
  };
...
var init_out_name_checker = __esm(() => {
  invalidCharacters = ["?", "*", "+", ":", "%"];
});
...
var initialState2, reducer2 = (state, action) => {
  if (action.type === "start") {
    return {
      type: "load"
    };
  ...
  return state;
}, container58, optionsPanel, horizontalLayout, leftSidebar, horizontalTab, iconContainer, icon6, buttonStyle7, flexer, outer4, RenderModal = ({
  initialFrame,
...
var init_RenderModal = __esm(() => {
  init_ShortcutHint();
  init_render_modal_sections();
  init_use_keybinding();
  init_Checkmark();
  init_audio();
  init_data();
  ...
  init_CrfSetting();
  init_DataEditor();
  init_RenderModalAdvanced();
  init_RenderModalAudio();
  init_RenderModalBasic();
  init_RenderModalGif();
  init_RenderModalPicture();
  init_ResolveCompositionBeforeModal();
  init_get_default_codecs();
  init_out_name_checker();
  initialState2 = { type: "idle" };
  container58 = {
    display: "flex",
    flexDirection: "row",
    alignItems: "center",
...
var progressItem, label9, right3, BundlingProgress = ({ progress, doneIn }) => {
...
var init_GuiRenderStatus = __esm(() => {
  init_layout();
  init_actions();
  init_CircularProgress();
  init_RenderQueueOpenInFolder();
...
var container59, codeBlock, spacer3, buttonRow, RenderStatusModal = ({
  jobId
}) => {
...
var init_RenderStatusModal = __esm(() => {
  init_retry_payload();
  init_modals();
  init_Button();
  init_ModalContainer();
...
var iconStyle8, buttonContainerStyle, copyIcon, labelStyle5, CopyButton = ({ textToCopy, label: label10, labelWhenCopied }) => {
...
var svgStyle4, buttonStyle8, OpenIssueButton = ({ link: link3 }) => {
...
var init_OpenIssueButton = __esm(() => {
  svgStyle4 = {
    width: "11px",
    height: "11px"
  };
...
var container60, text3, KnownBugs = ({ bugs }) => {
...
var init_KnownBugs = __esm(() => {
  init_OpenIssueButton();
  container60 = {
    display: "flex",
    flexDirection: "row",
    alignItems: "center"
...
var container61, text4, title7, code, link3, commands, UpdateModal = ({ info, knownBugs }) => {
...
var init_Modals = __esm(() => {
  ...
  init_AskAiModal();
  init_InstallPackage();
  init_DeleteComposition();
  init_DuplicateComposition();
  init_RenameComposition();
  init_QuickSwitcher();
  init_RenderModal();
  init_RenderStatusModal();
  init_UpdateModal();
});
...
var background2, DEFAULT_BUFFER_STATE_DELAY_IN_MILLISECONDS = 300, BUFFER_STATE_DELAY_IN_MILLISECONDS, Editor = ({ Root, readOnlyStudio }) => {
...
var init_Editor = __esm(() => {
  ...
  BUFFER_STATE_DELAY_IN_MILLISECONDS = typeof process.env.BUFFER_STATE_DELAY_IN_MILLISECONDS === "undefined" || process.env.BUFFER_STATE_DELAY_IN_MILLISECONDS === null ? DEFAULT_BUFFER_STATE_DELAY_IN_MILLISECONDS : Number(process.env.BUFFER_STATE_DELAY_IN_MILLISECONDS);
});
...
var key5 = "remotion.previewSize", persistPreviewSizeOption = (option) => {
...
var init_CheckerboardProvider = __esm(() => {
  init_checkerboard();
});
...
var init_ModalsProvider = __esm(() => {
  init_modals();
});

// src/state/marks.ts
var localStorageKey5 = () => `remotion.editor.marksv2`, persistMarks = (marks) => {
...
var init_SetTimelineInOutProvider = __esm(() => {
  init_in_out();
});
...
var init_ShowGuidesProvider = __esm(() => {
  init_editor_guides();
});
...
var init_ShowRulersProvider = __esm(() => {
  init_editor_rulers();
});
...
var init_ZoomGesturesProvider = __esm(() => {
  init_editor_zoom_gestures();
});
...
var init_EditorContexts = __esm(() => {
  ...
  init_sidebar();
  init_VisualControls();
  init_CheckerboardProvider();
  init_get_zod_if_possible();
  init_MediaVolumeProvider();
  init_ModalsProvider();
  init_context();
  init_SetTimelineInOutProvider();
  init_ShowGuidesProvider();
  init_ShowRulersProvider();
  init_ZoomGesturesProvider();
});
...
var container62, message, inlineCode, pageIsGoingToReload = false, ServerDisconnected = () => {
...
var init_ServerDisconnected = __esm(() => {
  init_client_id();
  container62 = {
    position: "fixed",
    justifyContent: "flex-end",
...
__export(exports_internals, {
  StudioInternals: () => StudioInternals
});
var StudioInternals;
...
// src/renderEntry.tsx
import { useContext as useContext84, useEffect as useEffect78, useRef as useRef42, useState as useState88 } from "react";
...
import {
  ...
  getRemotionEnvironment as getRemotionEnvironment6,
  Internals as Internals65
} from "remotion";
import { NoReactInternals as NoReactInternals16 } from "remotion/no-react";
import { jsx as jsx270, jsxs as jsxs139 } from "react/jsx-runtime";
...
var DelayedSpinner = () => {
  const [show, setShow] = useState88(false);
  useEffect78(() => {
    const timeout = setTimeout(() => {
      setShow(true);
    }, 2000);
  ...
  return /* @__PURE__ */ jsx270(AbsoluteFill5, {
    style: {
      justifyContent: "center",
      alignItems: "center",
      fontSize: 13,
...
var GetVideoComposition = ({ state }) => {
  const { compositions, currentCompositionMetadata, canvasContent } = useContext84(Internals65.CompositionManager);
  const { setCanvasContent } = useContext84(Internals65.CompositionSetters);
  const portalContainer = useRef42(null);
  const [handle] = useState88(() => delayRender(`Waiting for Composition "${state.compositionName}"`));
  useEffect78(() => {
  ...
  useEffect78(() => {
    ...
    current.appendChild(Internals65.portalNode());
    continueRender(handle);
    return () => {
      current.removeChild(Internals65.portalNode());
    };
...
var getRootForElement = () => {
  ...
  root = ReactDOM8.createRoot(videoContainer);
  return root;
};
var renderToDOM = (content7) => {
  if (!ReactDOM8.createRoot) {
    ...
    ReactDOM8.render(content7, videoContainer);
    return;
  }
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "composition") {
    const markup = /* @__PURE__ */ jsxs139(Internals65.RemotionRoot, {
      logLevel: window.remotion_logLevel,
      numberOfAudioTags: 0,
      onlyRenderComposition: bundleMode.compositionName,
      currentCompositionMetadata: {
        props: NoReactInternals16.deserializeJSONWithSpecialTypes(bundleMode.serializedResolvedPropsWithSchema),
      ...
      children: [
        /* @__PURE__ */ jsx270(Root, {}),
        /* @__PURE__ */ jsx270(GetVideoComposition, {
          state: bundleMode
        })
      ]
    });
  ...
  if (bundleMode.type === "evaluation") {
    const markup = /* @__PURE__ */ jsx270(Internals65.RemotionRoot, {
      logLevel: window.remotion_logLevel,
      numberOfAudioTags: 0,
      onlyRenderComposition: null,
      currentCompositionMetadata: null,
      children: /* @__PURE__ */ jsx270(Root, {})
    });
    renderToDOM(markup);
  }
  if (bundleMode.type === "index") {
    ...
    renderToDOM(/* @__PURE__ */ jsx270("div", {
      children: /* @__PURE__ */ jsx270(DelayedSpinner, {})
    }));
    Promise.resolve().then(() => (init_internals(), exports_internals)).then(({ StudioInternals: StudioInternals2 }) => {
      renderToDOM(/* @__PURE__ */ jsx270(StudioInternals2.Studio, {
        readOnly: true,
        rootComponent: Root
      }));
    }).catch((err) => {
      renderToDOM(/* @__PURE__ */ jsxs139("div", {
        children: [
...
if (typeof window !== "undefined") {
  const getUnevaluatedComps = () => {
    ...
    if (!Internals65.compositionsRef.current) {
      throw new Error("Unexpectedly did not have a CompositionManager");
    }
    const compositions = Internals65.compositionsRef.current.getCompositions();
    const canSerializeDefaultProps = getCanSerializeDefaultProps(compositions);
    if (!canSerializeDefaultProps) {
      Internals65.Log.warn(window.remotion_logLevel, "defaultProps are too big to serialize - trying to find the problematic composition...");
      for (const comp of compositions) {
      ...
      Internals65.Log.warn(window.remotion_logLevel, "Could not single out a problematic composition -  The composition list as a whole is too big to serialize.");
  ...
  window.getStaticCompositions = () => {
    ...
    const inputProps = typeof window === "undefined" || getRemotionEnvironment6().isPlayer ? {} : getInputProps2() ?? {};
    return Promise.all(compositions.map(async (c) => {
      ...
      const comp = Internals65.resolveVideoConfig({
      ...
      return {
        ...
        serializedDefaultPropsWithCustomSchema: NoReactInternals16.serializeJSONWithSpecialTypes({
          data: defaultProps,
          indent: undefined,
          staticBase: null
        }).serializedString
  ...
  window.remotion_calculateComposition = async (compId) => {
    ...
    const prom = await Promise.resolve(Internals65.resolveVideoConfig({
