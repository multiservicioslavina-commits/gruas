...
// ../../node_modules/.pnpm/mime-db@1.51.0/node_modules/mime-db/db.json
...
// ../../node_modules/.pnpm/mime-db@1.51.0/node_modules/mime-db/index.js
...
// ../../node_modules/.pnpm/mime-types@2.1.34/node_modules/mime-types/index.js
...
var findFunctionName = async ({
  ...
  if (cliFlag) {
    ...
    if (!compatibleFunctionExists) {
      Log.warn({ indent: false, logLevel }, `Function "${cliFlag}" does not match naming convention ${LambdaClientInternals15.innerSpeculateFunctionName({ diskSizeInMb: "[disk]", memorySizeInMb: "[memory]", timeoutInSeconds: "[timeout]" })}.`);
...
var renderStillOnLambda2 = NoReactInternals6.ENABLE_V5_BREAKING_CHANGES ? () => {
...
export {
  ...
  simulatePermissions,
  renderVideoOnLambda,
  renderStillOnLambda2 as renderStillOnLambda,
  renderMediaOnLambda,
  presignUrl,
  getUserPolicy,
