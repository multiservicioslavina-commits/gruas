...
const streamRenderer = ({ payload, functionName, outdir, overallProgress, files, logLevel, onArtifact, providerSpecifics, insideFunctionSpecifics, }) => {
...
const streamRendererFunctionWithRetry = async ({ payload, files, functionName, outdir, overallProgress, logLevel, onArtifact, providerSpecifics, insideFunctionSpecifics, }) => {
    if (payload.type !== serverless_client_1.ServerlessRoutines.renderer) {
        throw new Error('Expected renderer type');
    }
