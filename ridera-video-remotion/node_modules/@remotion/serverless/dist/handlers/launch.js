...
const innerLaunchHandler = async ({ params, options, overallProgress, registerCleanupTask, providerSpecifics, insideFunctionSpecifics, onBrowser, }) => {
    ...
    (0, serverless_client_2.validateFramesPerFunction)({
    ...
    const rendererFunctionName = (_d = params.rendererFunctionName) !== null && _d !== void 0 ? _d : insideFunctionSpecifics.getCurrentFunctionName();
    const renderMetadata = {
        ...
        region: insideFunctionSpecifics.getCurrentRegionInFunction(),
        renderId: params.renderId,
        outName: (_e = params.outName) !== null && _e !== void 0 ? _e : undefined,
        privacy: params.privacy,
        everyNthFrame: params.everyNthFrame,
        frameRange: realFrameRange,
        ...
        dimensions: {
            width: comp.width * ((_f = params.scale) !== null && _f !== void 0 ? _f : 1),
            height: comp.height * ((_g = params.scale) !== null && _g !== void 0 ? _g : 1),
        },
        rendererFunctionName: (_h = params.rendererFunctionName) !== null && _h !== void 0 ? _h : insideFunctionSpecifics.getCurrentFunctionName(),
    };
    const { key, renderBucketName, customCredentials } = (0, serverless_client_2.getExpectedOutName)({
        ...
        customCredentials: typeof params.outName === 'string' ||
            ...
            ? null
            : ((_k = (_j = params.outName) === null || _j === void 0 ? void 0 : _j.s3OutputProvider) !== null && _k !== void 0 ? _k : null),
        bucketNamePrefix: providerSpecifics.getBucketPrefix(),
    });
    if (!params.overwrite) {
